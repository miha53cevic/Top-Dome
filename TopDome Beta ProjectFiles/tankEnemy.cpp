...
tankEnemy::tankEnemy(float posX, float posY, float fSpeed)
	: Enemy(posX, posY, fSpeed)
{
	m_enemy.setSize(sf::Vector2f(30, 30));
	setColour(sf::Color::Magenta);

	m_HP = 3;
}

void tankEnemy::Update(std::string& map, const sf::Vector2i& mapSize, const sf::Vector2i& pixelSize, sf::Time Elapsed)
{
